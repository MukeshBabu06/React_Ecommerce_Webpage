...
export default function MTshirt({ cart, setCart }) {
  const [MensTshirts] = useState(data.Tshirts);

  return (
    <div>
      <Container lg={12} md={8} fluid className="EPrdlist">
        <h1 className="mt-2 mb-2 text-center">Men's T shirts</h1>
